...
if ( ! class_exists( 'Masterchef_Widget_Area' ) ) {

	class Masterchef_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'masterchef_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'masterchef_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'masterchef_widget_area_classes', $classes, $area_id );
	...
	function masterchef_widget_area() {
		return Masterchef_Widget_Area::get_instance();
	}

	masterchef_widget_area();
}
