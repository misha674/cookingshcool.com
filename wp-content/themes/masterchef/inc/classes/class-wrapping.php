 ...
 */
add_filter( 'template_include', array( 'Masterchef_Wrapping', 'wrap' ), 99 );
add_filter( 'masterchef_wrap_base', 'masterchef_wrap_base_cpts' );
 ...
 */
function masterchef_template_path() {
	return Masterchef_Wrapping::$main_template;
}
 ...
 */
function masterchef_template_base() {
	return Masterchef_Wrapping::$base;
}

if ( ! class_exists( 'Masterchef_Wrapping' ) ) {
	...
	class Masterchef_Wrapping {
		...
		/**
		 * Initialize new instance of Masterchef_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'masterchef_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Masterchef_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Masterchef_Wrapping();
		}
	}
}
 ...
 */
function masterchef_wrap_base_cpts( $templates ) {
