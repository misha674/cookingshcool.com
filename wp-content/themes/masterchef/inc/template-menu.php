 ...
 * @return void
 */
function masterchef_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon fa fa-bars" aria-hidden="true"></i>
			<?php echo esc_html__( 'Menu', 'masterchef' ); ?>
		</button>
		<?php
			$args = apply_filters( 'masterchef_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'masterchef_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'masterchef' ),
			) );
 ...
 * @return void
 */
function masterchef_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'masterchef_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'masterchef' ),
		) );
 ...
 * @return string
 */
function masterchef_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'masterchef_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'masterchef_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'masterchef' ),
	), $context, $type );
 ...
 * @return void
 */
function masterchef_set_nav_menu( $args ) {
