<?php
/**
 * About Masterchef widget.
 *
 * @package Masterchef
 */

if ( ! class_exists( 'Masterchef_About_Widget' ) ) {

	class Masterchef_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'masterchef' );
			$this->widget_id          = 'masterchef_widget_about';
			$this->widget_name        = esc_html__( 'About Masterchef', 'masterchef' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Logo:', 'masterchef' ),
				),
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'masterchef' ),
					),
				),
				'content'  => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'masterchef' ),
					'value'             => '',
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'masterchef_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'masterchef_register_about_widget' );
function masterchef_register_about_widget() {
	register_widget( 'Masterchef_About_Widget' );
}
